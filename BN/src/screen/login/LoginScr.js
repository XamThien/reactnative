                ...
                >
                    <View style={styles.container}>
                        <View style={styles.layoutTop}>
                            ...
                            />
                            <Text style={styles.textTop}>{Translate(DefineKey.Login_title)}</Text>
                        </View>

                        <View style={styles.layoutContent}>
                            <Text style={styles.textTitleInput}>{Translate(DefineKey.Login_username)}</Text>
                            ...
                            >
                                <Text style={styles.textButton}>{Translate(DefineKey.StartScreen_text_btn_login)}</Text>
                            </TouchableOpacity>

                            <Text
                                style={styles.textRegister}
                                onPress={() => this.props.navigation.navigate(ScreenName.Screen_Register)}
                            >
