export default {
  ...
  Statistic_title: "Thống kê",
  WorkCalendar_titleHead: "Lịch làm việc",
  Examination_Schedule_head_title: "Lịch Khám",

  HomeNavigation_title_work_calendar: "Lịch làm việc",
  HomeNavigation_title_examination_schedule: "Lịch khám",
  HomeNavigation_title_examination: "Khám bệnh",
  HomeNavigation_title_statistic: "Thống kê",
  ...
  // define lable, name, tile, button ... in home-schedule-patient
  Status_request_comfirm: "Xác nhận",
  Status_request_decline: "Từ chối",
  Status_request_callnow: "Gọi ngay",

  // define lable, name, tile, button ... in home-schedule-profile
  Profile_patient_records:"Hồ Sơ Bệnh Nhân",
  Profile_information: "Thông tin",
  Profile_medical_examination_detail:"Chi tiết khám",
  Profile_disease_profile:"Bệnh án",
  Profile_insurrance:"Bảo hiểm",
  Profile_prescription:"Đơn thuốc",
  Profile_medical_examination_history:"Lịch sử khám",

  // define lable, name, tile, button ... in home-schedule-examination_schedule
  Examination_schedule_patient_list:"Danh Sách Bệnh Nhân",
  Examination_schedule_confirm_title:"Xác Nhận",
  Examination_schedule_confirm_content:"Bạn có muốn chấp nhận cuộc gọi này không? Chọn đồng ý để chấp nhận, chọn Huỷ để từ chối",
  Examination_schedule_decline_content:"Bạn đã từ chối cuộc gọi này.",
  Examination_schedule_call_now_content:"Bạn có muốn gọi ngay bây giờ không?",

  // define lable, name, tile, button ... in home-videocall-booking-WaitingBookingMadal
  Videocall_Booking_button_comfirm: "Đồng Ý",
  Videocall_Booking_button_cancel: "Từ Chối",
  Videocall_outgoing_waiting_text: "Đang rung chuông...",
  ...
  Item_time_schedule_button_ok:"Đồng ý",
  Item_time_schedule_button_cancel:"Huỷ",
