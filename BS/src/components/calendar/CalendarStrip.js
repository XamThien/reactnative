...
class CalendarStrip extends Component {
  ...
  constructor(props) {
    ...
    console.log("nvTien selectedDate: " + selectedDate);
  ...
  onSelectDate(selectDate) {
    this.props.onSelectDate(selectDate);
  }
  ...
  onDateSelected(selectedDate) {
    ...
    console.log("nvTien selected date: " + selectedDate);
  ...
  onLayout(event) {
    ...
    let monthFontSize = Math.round(dayComponentWidth / 4);
